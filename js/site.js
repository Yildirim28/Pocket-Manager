...
function renderNavbar(session) {
    ...
    const installButton =
        ...
        'class="hidden items-center gap-1.5 rounded-lg border border-indigo-100 bg-white px-3 py-2 text-sm font-semibold text-indigo-700 shadow-sm transition-colors hover:bg-indigo-50">' +
    ...
    const mobileInstallButton =
        ...
        'class="hidden w-full items-center justify-center gap-1.5 rounded-lg border border-indigo-100 bg-white px-3 py-2 text-sm font-semibold text-indigo-700">' +
    ...
    const mobileAuth = user
        ? `<div class="border-t border-slate-100 pt-3">
               ...
               <button id="signOutBtnMobile" type="button"
                   class="mt-1 inline-flex w-full items-center justify-center gap-1.5 rounded-lg bg-slate-100 px-3 py-2 text-sm font-semibold text-slate-700">
                   <i data-lucide="log-out" class="h-4 w-4"></i> Sign out
               </button>
           </div>`
        : `<div class="border-t border-slate-100 pt-3">
               ${mobileInstallButton}
               <a href="login.html" class="mt-1 block rounded-lg px-3 py-2 text-sm font-medium text-slate-600 hover:bg-slate-100">Sign in</a>
